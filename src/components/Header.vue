    ...
    <header class="g s r vd ya cj">
        <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
            ...
            <div class="tc wf ig pb no">
                ...
                <label class="rc ab i">
                    <input type="checkbox" class="pf vd yc uk h r za ab" />
                    <!-- Icon Sun -->
                    <svg class="th om" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="/login"  class="ek pk xl">Sign In</a>
                <a href="/register" class="lk gh dk rg tc wf xf _l gi hi">Sign Up</a>
            </div>
            </div>
        </div>
    </header>
